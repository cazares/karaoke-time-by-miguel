...
# -*- coding: utf-8 -*-
"""
generate_ass_from_csv.py — converts lyrics_timing.csv → lyrics.ass
"""
...
Style: Default,Arial,64,&H00FFFFFF,&H000000FF,&H00000000,&H64000000,0,0,0,0,100,100,0,0,1,2,0,2,50,50,50,1
